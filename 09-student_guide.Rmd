...
```{r, echo = FALSE, results='asis'}
cow::borrow_chapter(
  doc_path = "child/__child_rstudio_video.Rmd",
  repo_name = "jhudsl/AnVIL_Template"
)
```
...
```{r, echo = FALSE, results='asis'}
cow::borrow_chapter(
  doc_path = "child/__child_rstudio_launch.Rmd",
  repo_name = "jhudsl/AnVIL_Template"
)
```
...
```{r, echo = FALSE, results='asis'}
cow::borrow_chapter(
  doc_path = "child/__child_rstudio_tour.Rmd",
  repo_name = "jhudsl/AnVIL_Template"
)
```
...
```{r, echo = FALSE, results='asis'}
cow::borrow_chapter(
  doc_path = "child/__child_rstudio_pause.Rmd",
  repo_name = "jhudsl/AnVIL_Template"
)
```
...
```{r, echo = FALSE, results='asis'}
cow::borrow_chapter(
  doc_path = "child/__child_rstudio_delete.Rmd",
  repo_name = "jhudsl/AnVIL_Template"
)
```